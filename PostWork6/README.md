#### Postwork sesión 1
#### Equipo 3 - BEDU
## Carlos / Viri / Sebastián / Diego

**1. Importar los datos de soccer de las temporadas 2019/2020** de la primera división de la liga española a R.

Se define el directorio en donde trabajaremos, posteriormente se guardan las direcciones URL, se descargan y se agregan y se leen los archivos .csv:
